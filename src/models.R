simple <- group(
  ...
  vo2_ml_min = function(.self, person, conf_level = 0.95) {
    ...
    y_hat_ci(x, "vo2_ml_min", .self, exp, NULL, conf_level)
  },
  vo2_ml_kg_min = function(.self, person, conf_level = 0.95) {
    ...
    y_hat_ci(x, "vo2_ml_kg_min", .self, identity, NULL, conf_level)
  },
  ...
  oxygen_pulse = function(.self, person, conf_level = 0.95) {
    ...
    y_hat_ci(x, "oxygen_pulse", .self, exp, NULL, conf_level)
  },
  ve_vco2_slope = function(.self, person, conf_level = 0.95) {
    ...
    y_hat_ci(x, "ve_vco2_slope", .self, function(x) x ^ (1 / -0.4), NULL, conf_level)
  },
...
fontan <- group(
  ...
  ve_vco2_slope = function(.self, person, conf_level = 0.95) {
    ...
    y_hat_ci(x, "ve_vco2_slope", .self, exp, NULL, conf_level)
  },
  breathing_frequency = function(.self, person, conf_level = 0.95) {
    x <- create_x(
      person, sex,
